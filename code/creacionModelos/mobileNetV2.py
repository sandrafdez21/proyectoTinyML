...
base_model = tf.keras.applications.MobileNetV2(
    input_shape=INPUT_SHAPE,   # De momento, mantenemos la deficicion original
...
# Compila y mide que tal esta funcionando
model.compile(
...
model.save('models/modeloMobileNetV2_96x96/modelo_mobileNetV2_96x96.keras')

# Se exporta en formato tflite
converter = tf.lite.TFLiteConverter.from_keras_model(model)
tflite_model = converter.convert()
with open('models/modeloMobileNetV2_96x96/modelo_mobileNetV2_96x96.tflite', 'wb') as f:
    f.write(tflite_model)


#------------------------------------------------------------------------------------------------------------------#

#CODIGO QUE MUESTRA DE FORMA VISUAL LA PRUEBA DEL MODELO
